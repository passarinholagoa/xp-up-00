...
export const QuickActions = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Level Progress */}
      <Card className="p-6 bg-gradient-to-br from-blue-500/10 to-purple-500/10 border-blue-500/20 backdrop-blur-sm">
      ...
      <Card className="p-6 bg-gradient-to-br from-yellow-500/10 to-orange-500/10 border-yellow-500/20 backdrop-blur-sm">
        <div className="space-y-4">
          <div className="flex items-center gap-3">
          ...
          <div className="space-y-3">
            ...
            <Button
              variant="ghost"
              size="sm"
              className="w-full text-sm text-muted-foreground hover:text-foreground hover:bg-yellow-500/10 border border-yellow-500/20 rounded-xl transition-all duration-200"
